             ...
             <div className="grid grid-cols-6 gap-2">
                {CATEGORY_PRESET_ICONS.map(i => (
                  <button
                    ...
                    type="button"
                    onClick={() => setIcon(i)}
                    className={`h-10 w-10 flex items-center justify-center rounded-xl text-xl transition-all hover:bg-slate-50 ${
                      icon === i ? 'bg-emerald-50 ring-2 ring-emerald-500 scale-110' : ''
                    }`}
                  >
                    {i}
                  </button>
                ...
                {CATEGORY_PRESET_COLORS.map(c => (
                  <button
                    ...
                    className={`h-8 w-8 rounded-full transition-all hover:scale-110 ${
                      color === c ? 'ring-4 ring-slate-100 scale-125' : ''
                    }`}
