        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
            <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden p-8">
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-500 text-sm">Start tracking your finances today</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-5">
                    ...
                    >
                        {loading ? <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin" /> : <UserPlus size={20} />}
                        Create Account
                    </button>
                </form>
